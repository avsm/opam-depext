...
let build_bytecode () =
  ...
  print_endline "ocamlc -w -3 -I vendor/cmdliner/src -I vendor/result unix.cma -o opam-depext `ocamldep -sort vendor/cmdliner/src/*.ml*` depext.ml"

let build_native () =
  print_endline "ocamlopt -c vendor/result/result.ml";
  print_endline "ocamlopt -w -3 -I vendor/cmdliner/src -I vendor/result unix.cmxa -o opam-depext `ocamldep -sort vendor/cmdliner/src/*.ml*` depext.ml"
